...
const Champions = () => {
  return (
    <div className='px-8 pt-24 md:px-24 text-center'>
        ...
        <div className='bg-gradient-to-r from-purple-500 to-blue-500 p-5 md:w-[75%] w-[90%] mx-auto rounded-lg shadow-md border-2'>
        ...
        <p className='text-5xl md:text-5xl  mt-24 font-semibold underline'>Our Champions</p>
