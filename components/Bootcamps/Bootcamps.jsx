    ...
    <section id='bootcamp' className='md:p-24 '>
      <div className='box-content bg-gradient-to-r text-center flex flex-col justify-center from-[#9374DC] to-[#58AFEF] rounded-md'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-1 gap-6 py-16 mb-24'>
          ...
          <div onClick={()=>router.push("/bootcamps/ethereum")} className='bg-black flex flex-col items-center col-span-1 p-4 place-self-center rounded-3xl hover:cursor-pointer  md:w-[20%] animate-pulse hover:animate-none hover:scale-125 transition-all'>
